 ...
 * Each cell of Current Aarray is a pointer to the first node of a linked list,
 ...
 * Each cell of Array is pointer to the first node of a linked list,
 * because we need HashTable to use Chaining collision handling
