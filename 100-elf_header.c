 ...
 * @e_ident: Pointer To An array That contain The ELF magic numbers.
 *
...
/**
 * print_class - Print The Class An ELF Header.
 * @e_ident: Pointer To The array That contain the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * ELF header at the start An ELF File.
